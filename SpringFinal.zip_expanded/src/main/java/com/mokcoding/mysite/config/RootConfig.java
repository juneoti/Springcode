...
@Configuration
@ComponentScan(basePackages = {"com.mokcoding.mysite.service"})
@ComponentScan(basePackages = {"com.mokcoding.mysite.aspect"})
@EnableAspectJAutoProxy
@EnableScheduling
@MapperScan(basePackages = {"com.mokcoding.mysite.persistence"})
